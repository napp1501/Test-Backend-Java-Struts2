    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <table id="inventoryTable" class="table table-hover align-middle">
                ...
                <s:iterator value="inventories" status="i">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <s:form id="deleteForm_%{id}" action="deleteInventory">
    ...
    <div class="modal fade" id="add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <h1 class="modal-title fs-5" id="staticBackdropLabelEdit">Add Inventory</h1>

                <s:form action="saveInventory" theme="simple">
                    ...
                    <div class="modal-body">
                        ...
                        <label class="mt-3">Type</label>
                            <s:select cssClass="form-select"
                                      ...
                                      list="typeList"
                                      headerKey=""
                                      headerValue="Select Type" required="true">
                            </s:select>
                    </div>
    ...
    <div class="modal fade" id="edit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <s:form action="editInventory" theme="simple">
                    <div class="modal-header">
...
<script>
    ...
    function editInven(id, itemId, qty, type) {
        $("#editId").val(id);
